...
// CanvasCell is a sentinel rune placed in viewport cells during canvas
// rendering mode. The client treats these cells as transparent, allowing
// the canvas image to show through. Menus/dialogs that overlap the
// viewport replace these cells with real content, rendering on top.
